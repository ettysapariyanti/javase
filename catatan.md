...
Membuat form untuk mengubah tulisan di label, lengkap dengan menggunakan tombol:
...
public class file6 {
    ...
    public static void membuatWindow(){
        ...
        tbUbahNamaEmiten.setBounds(10, 100, 220, 30);
        
        lbTampilNamaEmiten.setBounds(10,150, 350, 30);
